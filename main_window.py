...
from categories_gui import CategoriesWindow
...
class MainWindow:
    def __init__(self):
        ...
        self.done_button = tk.Button(frame2, text="Done", command=self._open_categories_gui, bg="#ccffff")
    ...
    def _open_categories_gui(self):
        self.root.destroy()
        gui = CategoriesWindow()
